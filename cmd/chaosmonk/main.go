...
import (
	...
	"github.com/tahcohcat/chaosmonk/internal/llm"
	"github.com/tahcohcat/chaosmonk/internal/llm/ollama"
	"github.com/tahcohcat/chaosmonk/internal/quotes"
)
...
func main() {
	...
	var rootCmd = &cobra.Command{
		Use:   "chaosmonk",
		Short: "Get a random quote with chaos and personality",
		Long:  "Fetches a random quote and transforms it with chaotic personality using Ollama LLM",
